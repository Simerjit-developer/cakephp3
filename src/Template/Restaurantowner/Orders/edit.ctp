                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">Edit Restaurant</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <?php echo $this->Form->checkbox('status', ['class' => 'form-control form-control-success', 'label' => false]); ?>
                                </div> 
                            </div>

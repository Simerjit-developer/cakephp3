...
//                                        print_r($key);
                                        if($restaurant->user_id == $key){
                                            echo "<p>".$user."</p>"; 
                                          //  print_r($restaurant->user_id);
                                        }
                                    } ?>
                                    <?php //echo $this->Form->control('user_id', ['options' => $users, 'class' => 'form-control form-control-success', 'label' => false,'readonly'=>true]); ?>
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    ['empty' => '(choose one)', 'class' => 'form-control form-control-success', 'label' => false,]
            ...
            <!--div class="row" style="margin-top:20px;">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">Add Amenities</h3>
                        </div>
                        <div class="card-body">
                            <?= $this->Form->create($restaurant, ['type' => 'file','url'=>['action'=>'addAmenities',$restaurant['id']]], array('class' => 'form-horizontal')) ?>
                            <div class="form-group row">
                                <label class="col-sm-3 form-control-label">Amenities</label>
                                <div class="col-sm-9">
                                   <ul id="easySelectable">

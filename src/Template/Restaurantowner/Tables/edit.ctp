...
<div class="content-inner">
    ...
    <div class="breadcrumb-holder container-fluid">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><?php echo $tables_label; ?></li>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4"><?php echo $edit." ".$tables_label; ?></h3>
                        </div>
                        <div class="card-body">
                            <?= $this->Form->create($table, array('class' => 'form-horizontal')) ?>
                            

                            <div class="form-group row">
                                <label class="col-sm-3 form-control-label"><?php echo $waiter_label; ?></label>
                                <div class="col-sm-9">

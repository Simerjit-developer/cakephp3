                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4"><?php echo $edit." ".$user_label; ?></h3>
                        </div>
                        <div class="card-body">
                            <?= $this->Form->create($user,['type' => 'file'], array('class' => 'form-horizontal')) ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <?php echo $this->Form->control('old_image',['type'=>'hidden','class'=>'','label'=>false,'value'=>$user['image']]); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="i-checks">
                                        ...
                                        <input type="checkbox" name="status" value="1" class="checkbox-template" <?php echo $checked; ?>>

                ...
                <div class="col-lg-6">
                    <div class="info d-flex align-items-center">
                        <div class="content">
                            ...
                            <p>Only Restaurant Owner will be allowed to access this panel.</p>
                        </div>
                    </div>
                </div>
                <!-- Form Panel    -->
                    ...
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            ...
                            <?= $this->Form->create('', array('class' => 'form-validate')) ?>
                                ...
                                <div class="form-group">
                                    <?php //echo $this->Form->control('password', ['id'=>'login-password','class' => 'input-material', 'label' => false]); ?>
                            ...
                            <?= $this->Form->end() ?>
                                ...
                                <?php echo $this->Html->link(
                                        'Forgot Password?',
                                        ['controller' => 'Users', 'action' => 'forgotPassword', '_full' => true],['class'=>'forgot-pass']
                                    ); ?>
                            <br>

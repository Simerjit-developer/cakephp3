                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4"><?php echo $edit." ".$restaurant_label; ?></h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <?php echo $this->Form->control('old_image',['type'=>'hidden','class'=>'','label'=>false,'value'=>$restaurant['image']]); ?>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 form-control-label"><?php echo $commission_label; ?>(%)</label>
                                <div class="col-sm-9">
                                    <?php echo $this->Form->control('commision', ['class' => 'form-control form-control-success', 'label' => false, 'min'=>0]); ?>
                                </div>
                            </div>
<!--                              <div class="form-group row">
                                <label class="col-sm-3 form-control-label">Gratuity</label>
                                <div class="col-sm-9">
                                    <?php //echo $this->Form->control('gratuity', ['class' => 'form-control form-control-success', 'label' => false]); ?>
                                </div>
                            </div>-->
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                   <ul id="easySelectable">
                                       ...
                                       <label class="checkbox-inline">
                                           <?php if(in_array($key, $my_amenities)){ ?>
                                               <input type="checkbox" name="amenities[]" value="<?php echo $key; ?>" checked/>
                                               <li class="es-selectable es-selected" data-id="<?php echo $key; ?>"><?php echo $value; ?></li>
                                            <?php }else{ ?>
...
<script>
    ...
    function initMap() {
        ...
        var lat_filled = parseFloat(document.getElementById("latitude").value);
        var long_filled = parseFloat(document.getElementById("longitude").value);
        var map = new google.maps.Map(document.getElementById('map'), {
            center: {lat:lat_filled , lng: long_filled},
            zoom: 13
        });
